...
--END_GAME_ON_TOWERKILLS = true
--TOWERKILLS_TO_END_GAME_FOR_TEAM = 2

END_GAME_ON_KILLS = true                -- Should the game end after a certain number of kills?
KILLS_TO_END_GAME_FOR_TEAM = 15        -- How many kills for a team should signify an end of game?
...
AUTO_LAUNCH_DELAY = 20                  -- How long should the default team selection launch timer be?  The default for custom games is 30.  Setting to 0 will skip team selection.
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 197, 77, 168 }  --    Spectator Team
